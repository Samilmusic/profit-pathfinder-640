...
const DEST_TYPES: { key: string; label: string; match: DestFilter }[] = [
  ...
  { key: "held_milad",     label: "Cash with Milad",    match: (a) => a.account_type === "person_holding" && a.owner === "milad" },
  { key: "held_ali",       label: "Cash with Ali",      match: (a) => a.account_type === "person_holding" && a.owner === "ali" },
  { key: "held_customer",  label: "Cash with Customer", match: (a) => a.account_type === "person_holding" && !["milad","ali"].includes(String(a.owner)) },
